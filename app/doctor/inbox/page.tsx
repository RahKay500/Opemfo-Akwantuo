  ...
  return (
    <main className="flex flex-col">
      <div className="relative flex flex-col justify-end rounded-b-3xl bg-primary px-6 pb-5 pt-11">
        <p className="font-heading text-[22px] font-bold text-lilac-deeper">Inbox</p>
        <p className="mt-1 font-body text-[13px] text-lilac-deeper/70">Records shared with you</p>
      </div>

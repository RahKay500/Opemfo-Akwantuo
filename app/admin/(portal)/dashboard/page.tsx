    ...
    <>
          ...
          <div className="rounded-lg border border-[#E2E8F0] bg-white p-5">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <Link
                ...
                className="rounded-md border border-dashed border-[#F6D0FE] bg-[#FDF4FF] px-4 py-2.5 text-sm font-medium text-[#9F1AB1]"
              >
                + Add New Facility
              </Link>
              <Link
      ...
      <div className="mt-6 rounded-lg border border-[#E2E8F0] bg-white p-5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/admin/facilities" className="text-sm font-medium text-[#9F1AB1]">
            View all →
          </Link>
        </div>

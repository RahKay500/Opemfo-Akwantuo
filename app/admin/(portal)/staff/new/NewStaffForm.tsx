...
export default function NewStaffForm({ facilities }: { facilities: { id: string; name: string }[] }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/admin/staff", {
        ...
        body: JSON.stringify({ name, phone, role, facilityId, licenseNumber: licenseNumber || undefined }),
      });

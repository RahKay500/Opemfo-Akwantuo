  ...
  return (
    <main className="flex flex-col">
      ...
      <div className="flex flex-col gap-5 px-5 pb-8 pt-5">
          ...
          <div className="mt-3 grid grid-cols-1 gap-3 lg:grid-cols-2">
            {REQUEST_TYPES.map((type) => (
              <button
                ...
                className={cn(
                  "flex flex-col items-start rounded-card border-2 p-5 text-left",
        ...
        <div className="flex flex-col gap-4 lg:rounded-card lg:bg-white lg:p-6 lg:border border-border-color">

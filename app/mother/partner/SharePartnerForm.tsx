  ...
  return (
    <div className="flex flex-col gap-4 px-5 pb-8 pt-5 lg:grid lg:grid-cols-2 lg:items-start lg:gap-6">
      ...
      <button
        ...
        disabled={busy}
        className="h-14 w-full rounded-button bg-pink-accent font-heading text-[17px] font-bold text-white disabled:opacity-60 lg:col-span-2"
      >
      ...
      <button
        type="button"
        onClick={() => router.back()}
        className="h-12 w-full rounded-button bg-white font-body text-sm font-medium text-text-secondary lg:col-span-2"
      >
        Cancel
      </button>
    </div>

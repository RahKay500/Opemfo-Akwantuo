  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative flex size-10 items-center justify-center rounded-lg border border-[#E2E8F0] bg-white/60 backdrop-blur-md transition-colors hover:bg-white/80"
      >
